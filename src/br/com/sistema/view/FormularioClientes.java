...
public class FormularioClientes extends javax.swing.JDialog {
     ...
     *
     * 1. Cria um novo objeto {@link br.com.sistema.Clientes} e define seus atributos com os
...
public void Excluir() {
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, painel_dados_pessoaisLayout.createSequentialGroup()
                        .addGroup(painel_dados_pessoaisLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(painel_dados_pessoaisLayout.createSequentialGroup()
                                ...
                                .addGap(22, 22, 22)
                                .addComponent(txtRG, javax.swing.GroupLayout.DEFAULT_SIZE, 241, Short.MAX_VALUE)
                                .addGap(6, 6, 6)
                                .addComponent(jLabel14)
                                .addGap(18, 18, 18)
                                .addComponent(txtCpf, javax.swing.GroupLayout.DEFAULT_SIZE, 242, Short.MAX_VALUE)
                                .addGap(200, 200, 200)))
                        .addGap(3, 3, 3)
   ...
   jProgressBar1.setIndeterminate(true); // Ativa o modo indeterminado 
    new Thread(() -> {
          try {              
              new relatorios.RelClientes(); // Gera o relatório
              // Simula um atraso (se necessário)
              Thread.sleep(1000); 
